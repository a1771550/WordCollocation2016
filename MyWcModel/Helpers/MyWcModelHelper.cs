...
namespace MyWcModel.Helpers
{
	public static class MyWcModelHelper
	{
		...
		public static List<word> GetColWordListByWordPattern(string word, CollocationPattern pattern)
		{
			...
			return collocationList.Select(collocation => new word
			{
				...
				EntryZhs = collocation.colword.EntryZhs,
				EntryJap = collocation.colword.EntryJap,
				Id = collocation.colWordId,
